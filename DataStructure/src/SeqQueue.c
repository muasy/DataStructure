...
/*
*********************************************************************************************************
* Function Name : GetSeqQueueDataBase
* Description	: 获取顺序队列数据地址
* Input			: None
* Output		: None
* Return		: None
*********************************************************************************************************
...
{
	return queuePtr->basePtr;
}

/*
*********************************************************************************************************
* Function Name : GetSeqQueueData
* Description	: 获取顺序队列数据
* Input			: None
* Output		: None
* Return		: None
*********************************************************************************************************
		...
		uint32_t dataNums, void (*pop_CallBack)( void *base, uint32_t offset, void *data ))
{
	...
	for (uint32_t i=0; i<dataNums; ++i)
	{
		if (PopSeqQueue(&queue, (uint8_t *)buff + (dataSize * i), pop_CallBack) != STATUS_DATA_STRUCT_TRUE)
		{
			break;
		}
		readNums++;
